(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.getSetter("classname").set("FileUpDownload");
            if (Form == this.constructor)
            {
                this._setFormPosition(1024,582);
            }
            ...
            obj = new Static("st_bg","42","165","480","267",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_files","52","214","460","202",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            ...
            obj = new Static("st_helpMessage","54","216","455","198",null,null,null,null,null,null,this);
            obj.set_taborder("32");
            obj.set_text("마우스로 파일을 끌어오세요.");
            this.addChild(obj.name, obj);

            obj = new Static("st_title00","42","56","454","38",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("File Upload");
            this.addChild(obj.name, obj);

            obj = new ImageViewer("img_loading","191","294","200","60",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("st_downloadTitle","552","166","457","38",null,null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_text("File Download");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("st_downloadBg","552","203","460","221",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_download","560","214","444","200",null,null,null,null,null,null,this);
            obj.set_taborder("25");
            ...
            obj = new Button("btn_selectFiles","191","176","118","30",null,null,null,null,null,null,this);
            obj.set_taborder("26");
            obj.set_text("Add Files...");
            this.addChild(obj.name, obj);

            obj = new Button("btn_clearAll","315","176","110","30",null,null,null,null,null,null,this);
            obj.set_taborder("27");
            obj.set_text("Delete All");
            this.addChild(obj.name, obj);

            obj = new Button("btn_save","432","176","75","30",null,null,null,null,null,null,this);
            obj.set_taborder("28");
            obj.set_text("Save");
            this.addChild(obj.name, obj);

            obj = new Static("st_support_dnd","60","92","460","20",null,null,null,null,null,null,this);
            obj.set_taborder("29");
            obj.set_text("• Drag and Drop 지원");
            this.addChild(obj.name, obj);

            obj = new Static("st_support_progressBar","60","113","460","20",null,null,null,null,null,null,this);
            obj.set_taborder("30");
            obj.set_text("• ProgressBar 지원");
            this.addChild(obj.name, obj);

            obj = new Static("st_support_multiple","60","136","460","20",null,null,null,null,null,null,this);
            obj.set_taborder("31");
