(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnAdd","25","26","67","31",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("추가");
            this.addChild(obj.name, obj);

            obj = new Button("btnDel","100","26","67","31",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("삭제");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnSave","173","26","67","31",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("전송");
            this.addChild(obj.name, obj);
        ...
        this.downloadfile = function(i)
        {
        	...
        	this.fileDownTrans.download(this.saveUrl+"l.jsp");
        }
