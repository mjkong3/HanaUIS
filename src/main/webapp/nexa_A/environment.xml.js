if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("svcEasyUITutorial", "model", "./svcEasyUITutorial/", "session", null, "", "0", "0");
        nexacro._addService("MainBase", "form", "./MainBase/", "session", null, "", "0", "0");
        nexacro._addService("image", "file", "./image/", "session", null, "", "0", "0");
        nexacro._addService("svc", "JSP", "http://localhost:8082/HanaUIS/", "none", null, "", "0", "0");
