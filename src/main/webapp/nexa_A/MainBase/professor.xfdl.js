(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_cssclass("ATEAM");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\" band=\"left\"/><Column size=\"45\"/><Column size=\"62\"/><Column size=\"80\"/><Column size=\"101\"/><Column size=\"137\"/><Column size=\"103\"/><Column size=\"40\"/><Column size=\"237\"/><Column size=\"63\"/><Column size=\"65\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHECK\"/><Cell col=\"1\" text=\"No\"/><Cell col=\"2\" text=\"교번\"/><Cell col=\"3\" text=\"성명\"/><Cell col=\"4\" text=\"연락처\"/><Cell col=\"5\" text=\"EMAIL\"/><Cell col=\"6\" text=\"생년월일\"/><Cell col=\"7\" text=\"성별\"/><Cell col=\"8\" text=\"주소\"/><Cell col=\"9\" text=\"재직여부\"/><Cell col=\"10\" text=\"학과코드\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHECK\"/><Cell col=\"1\" text=\"expr:currow + 1\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:PROFESSOR_ID\" textAlign=\"center\" displaytype=\"normal\" maskedittype=\"number\"/><Cell col=\"3\" text=\"bind:NAME\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:PHONE\" textAlign=\"center\"/><Cell col=\"5\" text=\"bind:EMAIL\" textAlign=\"center\"/><Cell col=\"6\" text=\"bind:BIRTHDAY\" textAlign=\"center\" displaytype=\"calendarcontrol\"/><Cell col=\"7\" text=\"bind:GENDER\" textAlign=\"center\"/><Cell col=\"8\" text=\"bind:ADDRESS\" textAlign=\"center\"/><Cell col=\"9\" text=\"bind:STATUS\" textAlign=\"center\"/><Cell col=\"10\" text=\"bind:DEPARTMENT_CODE\" textAlign=\"center\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Combo("cmb_Search","716","70","116","26",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Button("btn_Search","995","70","66","25",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("조회");
            this.addChild(obj.name, obj);

            obj = new Edit("edt_Search","837","70","153","26",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            this.addChild(obj.name, obj);

            obj = new Button("btn_Add","1065","70","66","25",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("등록");
            this.addChild(obj.name, obj);

            obj = new Button("btn_Delete","1134","70","66","25",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("삭제");
            this.addChild(obj.name, obj);

            obj = new Static("sta_RowCnt","1112","623","88","28",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("");
            obj.set_background("white");
            ...
            obj = new Static("Static00","1127","623","56","28",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("총원 :");
