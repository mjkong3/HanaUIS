(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("Search_Cmb","766","70","116","26",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Button("Select_btn","1045","70","66","25",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("조회");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit00","887","70","153","26",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            this.addChild(obj.name, obj);
