        ...
        this.updateCheck = function() {
        	...
        	for (var i = 0; i < nRow; i++) {
        		...
        		if (!/^\d*$/.test(inputValue) || !/^\d*$/.test(inputValue2) || !/^\d*$/.test(inputValue3)) {
        			...
        			this.ds_scoreList.setColumn(i,"MIDDLE_TEST", this.ds_scoreList.getOrgColumn(i, "MIDDLE_TEST"));
        			this.ds_scoreList.setColumn(i,"FINAL_TEST", this.ds_scoreList.getOrgColumn(i, "FINAL_TEST"));
        			this.ds_scoreList.setColumn(i,"REPORT", this.ds_scoreList.getOrgColumn(i, "REPORT"));
